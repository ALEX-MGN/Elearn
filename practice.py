...
class DataSet:
    ...
    def csv_ﬁler(self, reader, list_naming):
        ...
        Args:
            reader (list): Список со всеми параметрами вакансий
            list_naming (list): Все параметры в шапке
...
class Report:
    ...
    def generate_pdf(self, profession):
        ...
        readyHtmlTable = self.generate_table(profession)
    ...
    def generate_table(self, profession):
        ...
        >>> Report().generate_table(profession)
